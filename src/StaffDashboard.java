...
public class StaffDashboard extends javax.swing.JFrame {
    ...
    /**
     * Creates new form StaffConcerns
     */
    ...
    String sql = "SELECT c.id, t.full_name, t.unit_number, c.concern_text, c.created_at, c.status " +
                 ...
                 "WHERE DATE(c.created_at) = CURDATE()"; // Fetch only today's concerns
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tenant Name", "Unit no.", "Concerns", "Date & Time", "Status"
            }
        ));
        ...
        jButton1.setText("VIEW ALL CONCERNS");
        ...
        jLabel1.setText("Today's Concerns");

        jButton4.setBackground(new java.awt.Color(0, 0, 153));
        jButton4.setFont(new java.awt.Font("Arial", 1, 18)); // NOI18N
        jButton4.setForeground(new java.awt.Color(255, 255, 255));
        jButton4.setText("SUBMIT A CONCERN");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      new StaffViewConcerns().setVisible(true);
      dispose();
